...
const Latest = () => {
    ...
    return (
        <>
                ...
                <div className="upcoming-events" style={{ padding:"1.9rem"}}>
                    <h1 style={{textAlign: "center", padding:"1rem", fontFamily:"Inter"}}>Upcoming Events</h1>
                   
                    <div className='flex' id='trinityy'>
                    <div className='upcoming-event-div'>
                        <p className='info'>Introducing</p>
                        <h1 className='e-head' id='trinity-head'>TRINITY</h1>
                        <p className='info'>Learn to Design, Develop and Deploy!</p>
                        <br></br>
                        <p className='info'>25th Feb 2023</p>
                        <a href='https://trinity-register.vercel.app/' target="_blank" rel='noreferrer'>
                 ...
                 Register
                    ...
                    <img className='graphics' id='trinity' src='./Images/pink-trinity-logo.png' alt='hackathon'></img>
                    </div>
                 ...
                 Pre-Register
                    ...
                    <img className='graphics' src='./Images/UpcomingEvents/hackathon.png' alt='hackathon'></img>
                    </div>
                </div>
  ...
  sandbox="allow-scripts allow-same-origin">
            ...
            <p style={{padding:20,fontSize:20}}>In above code, the function square is passed as a parameter to map() function It calls the square function for all the elements present in the array arr and returns a whole new array which contains the squares of all the elements.
<br/>
<br/>
...
<p style={{padding:20,fontSize:20}}>There are many ways to write a map() function. The first way was the one which we used in the above code. Now, lets see some another ways:</p>
